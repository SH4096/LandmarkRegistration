...
class LocalSimpleITKPlugin(RegistrationPlugin):
  ...
  def refineLandmark(self, state):
    ...
    fixedImage = sitk.ReadImage(sitkUtils.GetCjyxITKReadWriteAddress(fixedVolume.GetName()) )
    movingImage = sitk.ReadImage(sitkUtils.GetCjyxITKReadWriteAddress(movingVolume.GetName()) )
...
try:
  ...
  cjyx.modules.registrationPlugins = {}
cjyx.modules.registrationPlugins['LocalSimpleITK'] = LocalSimpleITKPlugin
