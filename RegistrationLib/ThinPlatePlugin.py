...
class ThinPlatePlugin(RegistrationPlugin):
  ...
  def create(self,registrationState):
    ...
    exportGridButton.toolTip = "To save this transform or use it in other Cjyx modules you can export the current Thin Plate transform to a Grid Transform."
...
try:
  ...
  cjyx.modules.registrationPlugins = {}
cjyx.modules.registrationPlugins['ThinPlate'] = ThinPlatePlugin
